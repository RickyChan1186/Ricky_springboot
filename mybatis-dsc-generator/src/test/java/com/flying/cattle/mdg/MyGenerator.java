...
public class MyGenerator {
		...
		public static final String AUTHOR = "Ricky";
		public static final String VERSION = "V1.0";
		// 数据库连接信息：连接URL、用户名、秘密、数据库名
		public static final String URL = "jdbc:mysql://127.0.0.1:3306/test?useSSL=false&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf8";
		...
		public static final String TIME = "2020年11月18日";
		public static final String AGILE = new Date().getTime() + "";
		// 路径信息，分开路径方便聚合工程项目，微服务项目
		public static final String ENTITY_URL = "com.ricky.entity";
		public static final String DAO_URL = "com.ricky.mapper";
		public static final String XML_URL = "com.ricky.mapper.xml";
		public static final String SERVICE_URL = "com.ricky.service";
		public static final String SERVICE_IMPL_URL = "com.ricky.service.impl";
		public static final String CONTROLLER_URL = "com.ricky.web";
		//是否是Swagger配置
